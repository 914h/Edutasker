...
$r = "
    SELECT r.idrattrapage, e.nomecole, p.nom AS nomprof, g.nom AS nomgroup, r.matiere, r.description, r.deadline, r.pdf_path
    FROM `rattrapage` r
    JOIN `ecole` e ON r.idecole = e.idecole
    JOIN `prof` p ON r.idprof = p.idprof
    JOIN `group` g ON r.idgroup = g.idgroupe
    JOIN `etudiantgrp` eg ON r.idgroup = eg.idgroup
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="#"><i class="fa-solid fa-city"></i>
                                Mes Ratts</a>
                        </li>
                    </ul>
    ...
    <div class="west">
        <div class="container page" id="page">
            <div class="entete-list">
                <h1 class="display-4">Liste des Rattrapages</h1>
                <span class="nbr"></span>
            </div>
...
<table id="example" class="table table-responsive table-hover">
    ...
    <tbody>
        ...
        while ($data = mysqli_fetch_assoc($res1)) {
            echo "<tr>";
            echo "<td>" . $data['idrattrapage'] . "</td>";
            echo "<td>" . " " . $data['nomecole'] . "</td>";
