    ...
    <div class="west">
            ...
            <table id="example" class="table table-responsive table-hover">
                <div class="container page" id="page">
                    <div class="entete-list">
                        <h1 class="display-4">Liste des groups Ecole/Prof</h1>
                        <span class="nbr"></span>
                    </div>
                    <?php
                    ...
                    FROM 
                        ecoleprof
                    JOIN 
                        ecole ON ecoleprof.idecole = ecole.idecole
                    JOIN 
                        prof ON ecoleprof.idprof = prof.idprof
                ";
                    $res = mysqli_query($con, $r);
                    if ($res) {
                        $nbr_client = mysqli_num_rows($res);
                    ...
                    <tbody>
                        ...
                        while ($data = mysqli_fetch_assoc($res)) {
                            echo "<tr>";
                    echo "<td>" . $data['ecole_name'] . "</td>";
                    echo "<td>" . $data['prof_name'] . "</td>";
            ...
            <table id="example" class="table table-responsive table-hover">
                <div class="container page" id="page">
                    <div class="entete-list">
                        <h1 class="display-4">Liste des groups prof/group</h1>
                        <span class="nbr"></span>
                    </div>
                    <?php
                    require ("../connexion.php");
                    ...
                    SELECT 
                        ...
                        prof.nom as prof_name, 
                        profgrp.idgroup, 
                        `group`.nom as group_name, 
                        profgrp.matiere, 
                        profgrp.description
                    FROM 
                        profgrp
                    JOIN 
                        prof ON profgrp.idprof = prof.idprof
                    JOIN 
                        `group` ON profgrp.idgroup = `group`.idgroupe
                ";
                    $res = mysqli_query($con, $r);
                    if ($res) {
                        $nbr_client = mysqli_num_rows($res);
