...
if(!isset($_SESSION['v_session']) || $_SESSION['user_type'] !== 'professor') {
...
<body>
    <div class="main">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="./etudiant/etudiant-list-prof.php"><i class="fa-solid fa-city"></i> Liste
                                des Etudiants</a>
                        </li>
                    ...
                    <li class="nav-item">
              <a class="nav-link" href="#" ><?php echo 'Prof. ' . $prenom . " " . $nom ?> <i class="fa-solid fa-caret-down"></i></a>
            </li>
        ...
        <div class="heaad">
        <h1>Welcome to our Professeurs Dashboard <br>heres some details about the work !</></h1>  
        </div>
        <div class="details">
            <div class="cards">
                <div class="card">
                ...
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title"> <i class="fa-solid fa-users  fa-2xl"></i></h3>
                        <h6 class="card-subtitle mt-3 mb-3 text-muted">Le nombre de commandes existe dans la base de
                            données</h6>
                        <p class="card-text">
                            <?php
                            require ("connexion.php");
                ...
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title"> <i class="fa-solid fa-people-group fa-2xl"></i></h3>
                        ...
                        <p class="card-text">
                            ...
                            $table1_count = $row1['count'];
                            ?>
                            Nombre de etudiantgrp : <?php echo $table1_count; ?>
                        </p>
                        <a href="#" class="card-link">Afficher détails</a>
                    </div>
                </div>
