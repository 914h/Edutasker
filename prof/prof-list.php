    ...
    <div class="west">
        <div class="container page" id="page" >
            <div class="entete-list">
                <h1 class="display-4">Liste des profs</h1>
                <span class="nbr"></span>
            </div>

            <a href="prof-form-add.php" class="btn btn-success ttip" data-bs-toggle="tooltip" title="Ajouter une cabinet"
               >
            ...
            <table id="example" class="table table-responsive table-hover">
                ...
                <tbody>
                    ...
                    while ($data = mysqli_fetch_assoc($res)) {
                        ...
                        echo "<td>" . $data['tel'];
                        echo "<td>" . $data['email'];
                        echo "<td> <img src='../prof/images/$photo' width=80 height=80> </td>";
                        echo "<td> <a href=prof-form-update.php?id=" . urlencode($id) . " class='btn btn-primary'  data-bs-toggle='tooltip' title='Modifier cette ligne'>Edit</a>";
                        echo "<td> <a href=prof-form-delete.php?id=" . urlencode($id) . "  class='btn btn-danger'  data-bs-toggle='tooltip' title='Supprimer cette ligne'><i class='fa-solid fa-trash-can iconrouge'></i></a>";
                    }
                    mysqli_close($con);
                    ?>
                </tbody>
